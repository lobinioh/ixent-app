...
def open_browser(host, port):
    webbrowser.open_new('http://' + host + ':{}'.format(port))
...
if debug: app.run(debug=debug, port=dash_port, host=dash_host) # use flask server
else:
    print('*** Starting Waitress server on: ' + str(dash_host) + ' port: ' +str(dash_port))
    import os
